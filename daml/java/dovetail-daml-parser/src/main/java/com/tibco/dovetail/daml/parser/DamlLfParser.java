...
public class DamlLfParser {
	public static void main(String[] args) {
		...
		opts.addOption("h", "help", false, "print help");
		 ...
		 String header = "Extract metadata from DAR file\n\n";
		 String footer = "";
		...
		try {
			...
			if(cmds.hasOption('h') || cmds.hasOption("help")) {
				 formatter.printHelp("java -jar <path to daml parser jar>", header, opts, footer, true);
				 System.exit(0);
			}
		    ...
		    System.out.printf("finished, output is %s\n", outputpath);
		} catch (Throwable e) {
			e.printStackTrace();
			formatter.printHelp("java -jar <path to daml parser jar>", header, opts, footer, true);
		}
